...
if __name__ == "__main__":
    ...
    parser.add_argument("--ablation_dataset", type=str, default='1_100', help="1_10| 1_100| 1_100000| no_single_double | only_single_double|resized_set_theory|only_cluttered")

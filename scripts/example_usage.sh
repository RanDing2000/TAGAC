...
echo "    --raw_root /storage/user/dira/nips_data_version6/combined/targo_dataset \\"
echo "    --output_root /storage/user/dira/nips_data_version6/combined/targo_dataset"

echo ""
echo "3.2 Verify preprocessing results:"
echo "python scripts/verify_complete_target_preprocessing.py \\"
echo "    --dataset_root /storage/user/dira/nips_data_version6/combined/targo_dataset \\"
echo "    --raw_root /storage/user/dira/nips_data_version6/combined/targo_dataset"

...
def analyze_results(file_path):
    # 读取YCB类别映射
    ycb_path = "/usr/stud/dira/GraspInClutter/targo/targo_eval_results/eval_results_train_full-middle-occlusion-1000/targo/0/ycb.json"
    ...
    # 确保输出目录存在
    os.makedirs("/usr/stud/dira/GraspInClutter/targo/targo_eval_results/eval_results_train_full-middle-occlusion-1000/targo/0", exist_ok=True)
    
    # 写入文件
    with open("/usr/stud/dira/GraspInClutter/targo/targo_eval_results/eval_results_train_full-middle-occlusion-1000/targo/0/summary_by_category.txt", 'w') as f:
        f.write('\n'.join(output))
...
# 使用方法
file_path = "/usr/stud/dira/GraspInClutter/targo/targo_eval_results/eval_results_train_full-middle-occlusion-1000/targo/2025-03-25_00-08-19/meta_evaluations.txt"
